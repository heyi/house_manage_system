...
! function($) {
    ...
    Datepicker.prototype = {
        ...
        update: function() {
            ...
            date ? date: this.element.data('date'), this.format);
        ...
        mousedown: function(e) {
            ...
            if ($(e.target).is("button")) {
                this.date = DPGlobal.parseDate(null,this.format); 
                this.viewDate = new Date(this.date);
                this.fill();
                this.setValue();
                this.element.trigger({
    ...
    $.fn.datepicker = function(option) {
        return this.each(function() {
            ...
            if (!data) {
                $this.data('datepicker', (data = new Datepicker(this, $.extend({},
    ...
    DPGlobal.template = '<div class="datepicker dropdown-menu">' + '<div class="datepicker-days">' + '<table class=" table-condensed">' + DPGlobal.headTemplate + '<tbody></tbody>' + '</table><div style="width: 60px;margin:auto;"><button class="btn">今天</button></div>' + '</div>' + '<div class="datepicker-months">' + '<table class="table-condensed">' + DPGlobal.headTemplate + DPGlobal.contTemplate + '</table>' + '</div>' + '<div class="datepicker-years">' + '<table class="table-condensed">' + DPGlobal.headTemplate + DPGlobal.contTemplate + '</table>' + '</div>' + '</div>';
