    ...
    <body class="easyui-layout">
        ...
        <div data-options="region:'west',split:true" title="案例类型" style="width: 180px;overflow:hidden;">
            <div  class="easyui-accordion" data-options ='border:false,fit:true'>
                ...
                <div title="住宅"  style="" >
                    <a href="houseforsale.jsp" class="nav-item " data-houseType="2" data-dealType="1">
                ...
                <div title="办公" >
                    <a href="officeforhire.jsp" class="nav-item " data-houseType="3" data-dealType="1">
                ...
                <div title="工业" selected=true>
                    <a href="industryforsale.jsp" class="nav-item active" data-houseType="4" data-dealType="1">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" class="ui-form-table" width="100%">
                            <tr>
                                ...
                                <td class="ui-form-table-dd"> <input class="easyui-combotree" name="cityNo" data-options="url:'getCityList.do',onClick:_changeLatlng,onLoadSuccess:makeCityKeys,method:'get', lines:true" style="width: 188px;">
                                    <input type="hidden" name="houseType" value="4" />
            ...
            <fieldset style="border:1px solid #95B8E7; padding:5px;">
                ...
                <table cellspacing="0" >
					...
					<tr>
                        ...
                        <td><@= caseNo @> </td>
						<td>办公配套：</td>
                        <td colspan=3><@= officeFacilities @> </td>
                    </tr>
                    <tr>
                        <td colspan=6>
        ...
        <script src="industryforsale.js" type="text/javascript" charset="utf-8"></script>
