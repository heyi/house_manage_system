...
<html lang="en">
    ...
    <body class="easyui-layout">
	                ...
	                <div class="ui-layout-nav">
	                    ...
	                    <div class="ui-layout-nav-contain">
	                        <ul class="ui-layout-nav-tab">
	                            ...
	                            <li><a href="market2.jsp" class="ui-layout-nav-active">市场分析</a></li>
       ...
       <%@include file="footer.jsp" %>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="ui-form-table"  width="100%" height="100%">
                    ...
                    <tr rowspan=5 >
                        ...
                        <td class="ui-form-table-dd" colspan=3>
                            <textarea id="ckeditor" name="content" required="true" ></textarea>
                        </td>
                    </tr>
                    <tr>
        ...
        <script src="market2.js" type="text/javascript" charset="utf-8"></script>
    </body>
</html>
