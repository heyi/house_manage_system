...
<html lang="en">
    ...
    <body class="easyui-layout">
        ...
        <div data-options="region:'west',split:true" title="案例类型" style="width: 180px;overflow:hidden;">
            <div  class="easyui-accordion" data-options ='border:false,fit:true'>
                ...
                <div title="住宅"  style="" selected=true>
                    <a href="houseforhire.jsp" class="nav-item " data-houseType="2" data-dealType="1">
                        <img src="../resources/images/house.png" alt="shop" border="0"/>
                        住宅售价案例
                    </a>
                    <a  class="nav-item active" data-houseType="2" data-dealType="2">
                        <img src="../resources/images/house.png" alt="shop" border="0"/>
                        住宅租赁案例</a>
                </div>
                <div title="办公">
        ...
        <div class="easyui-dialog" id="dlg3"
            ...
            title="查看住宅租赁案例" style="width: 980px; height: 600px;;">
        ...
        <script src="houseforhire.js" type="text/javascript" charset="utf-8"></script>
