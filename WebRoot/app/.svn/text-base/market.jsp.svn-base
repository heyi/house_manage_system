...
<body class="easyui-layout" data-options="fit:true">
            ...
            <div class="ui-layout-nav">
                ...
                <div class="ui-layout-nav-contain">
                    <ul class="ui-layout-nav-tab">
                        ...
                        <li><a href="market.jsp" class="ui-layout-nav-active">市场分析</a></li>
    ...
    <div data-options="region:'west',split:true" title="市场分析" style="width: 200px;">
...
<script src="market.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>
