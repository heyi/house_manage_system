...
<body class="easyui-layout" data-options="fit:true">
                ...
                <span class="ui-layout-nav-prev"></span>
                    <div class="ui-layout-nav-contain">
                        <ul class="ui-layout-nav-tab">
                            ...
                            <li><a href="law.jsp"  class="ui-layout-nav-active">政策法规</a></li>
    ...
    <div data-options="region:'west',split:true" title="政策法规" style="width: 200px;">
...
<script src="law.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>
