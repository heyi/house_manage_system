...
var toolbar = [{
    ...
    handler: function() {
        flag = "add";
        dlg1.dialog("open").dialog('setTitle','添加住宅租赁案例');
        form1.form("clear");
...
'-', {
    ...
    handler: function() {
        ...
        if (r) {
            ...
            dlg1.dialog("open").dialog('setTitle','修改住宅租赁案例');
        }else {
...
table1.datagrid({
    ...
    columns:[[
        ...
        {width:80, field:'totalFloor', title:"总楼层"},
        {width:80, field:'floor', title:"电梯配套"},
        {width:80, field:'dealTime', title:"成交时间"}, 
        {width:200, field:'locate', title:"具体位置"}, 
        {width:80, field:'hirePrice', title:"租金总价(元)"}, 
        {width:120, field:'hireUnitPrice', title:"租金单价(元/m2/月)"}, 
