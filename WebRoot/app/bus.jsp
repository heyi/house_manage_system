    ...
    <body class="easyui-layout">
        ...
        <div data-options="region:'west',split:true" title="案例类型" style="width: 180px;overflow:hidden;">
            <div  class="easyui-accordion" data-options ='border:false,fit:true'>
                <div title="商铺"  style="">
                    <a href="javascript:void(0)" class="nav-item active" data-houseType="1" data-dealType="1">
                    ...
                    <form class="sf" method="post" id="form2">
                        <table border="0" cellspacing="0" cellpadding="0" class="ui-form-table" width="100%">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap" class="ui-form-table-dt">房屋名称：</td>
                                <td class="ui-form-table-dd"><input class="easyui-validatebox" name="houseName" data-options="" style="width: 190px;"></input></td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" class="ui-form-table-dt">所在楼层：</td>
                                <td class="ui-form-table-dd"><input class="easyui-validatebox" name="floor" data-options="" style="width: 190px;"></input></td>
                                <td colspan="4" class="ui-form-table-dd">
            ...
            <form id="form1">
                <fieldset style="border:1px solid #95B8E7; padding:5px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" class="ui-form-table">
                        ...
                        <tr>
                            <td class="ui-form-table-dt">楼层：</td>
                            <td class="ui-form-table-dd">
                                <input name="floor" class="easyui-numberspinner" style="width:149px;" data-options="min:2,max:200" required="true">
                            </td>
                            <td class="ui-form-table-dt">总楼层：</td>
                            <td class="ui-form-table-dd">
                                <input name="totalFloor" class="easyui-numberspinner" style="width:149px;" data-options="min:2,max:200" required="true">
                            </td>
                        ...
                        <tr>
                            <td class="ui-form-table-dt">公推面积：</td>
                            <td class="ui-form-table-dd">
        ...
        <script src="bus.js" type="text/javascript" charset="utf-8"></script>
