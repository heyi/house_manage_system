...
$ht = $("body").find("[name=houseType]"),
$dt = $("body").find("[name=dealType]"),
dlg_info = $("#dlg_info"),
dlg3 = $("#dlg3");

var fs_container = $("#fs_container");
var map, geo, marker, point, _lat = lat = 28.19580849444327,
_lng = lng = 112.95644760131836;
var bmap, mode;
...
'-', {
    ...
    handler: function() {
        ...
        if (r) {
            $.ajax({
                url: "deleteHouse.do?id=" + r.houseId
...
// setTimeout(function() {
//     $(".easyui-accordion").find("a.nav-item:first").trigger("click");
// },
// 0);
